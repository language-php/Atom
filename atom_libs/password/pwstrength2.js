...
(function ($) {
    ...
    var options = {
        ...
        setProgressBar = function ($el, score) {
            var options = $el.data("pwstrength2"),
        ...
        methods = {
            init: function (settings) {
                ...
                return this.each(function (idx, el) {
                    ...
                    $el.data("pwstrength2", allOptions);
                    ...
                    $el.data("pwstrength2").progressbar = progressbar;
            ...
            outputErrorList: function () {
                this.each(function (idx, el) {
                    var output = '<span class="error-list">',
                        $el = $(el),
                        errors = $el.data("pwstrength2").errors,
                        viewports = $el.data("pwstrength2").viewports,
                        verdict;
                    $el.parent().find("span.error-list").remove();
            ...
            changeScore: function (rule, score) {
                this.each(function (idx, el) {
                    $(el).data("pwstrength2").ruleScores[rule] = score;
                });
            },

            ruleActive: function (rule, active) {
                this.each(function (idx, el) {
                    $(el).data("pwstrength2").rules[rule] = active;
                });
            }
        };

    $.fn.pwstrength2 = function (method) {
        var result;
        if (methods[method]) {
            ...
            $.error("Method " +  method + " does not exist on jQuery.pwstrength2");
        }
        return result;
    };
}(jQuery));
